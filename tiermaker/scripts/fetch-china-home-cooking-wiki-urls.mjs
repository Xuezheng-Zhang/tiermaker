/**
 * 从英文维基 pageimages 与维基共享资源搜索解析图片 URL（不下载），
 * 维基无图时回退百度百科词条主图（og:image），
 * 写入 src/data/chinaHomeCooking49.generated.ts。
 *
...
/**
 * zh + 英文维基标题 + 可选直接 Commons File + 可选共享资源搜索关键词
 * file: 优先使用的 File: 完整标题（已核实存在时）
 * baike: 百度百科词条名（可多个依次尝试）；维基整条链路无图时用词条 og:image
 * skipEnWiki: 为 true 时不走英文维基（避免土豆、生茄子、卷心菜等泛图），顺序：file → 百科 → Commons 搜索 → 兜底
 */
const DISHES = [
  ...
  { zh: "地三鲜", file: "File:Disanxian.jpg", en: ["Di san xian"] },
  {
    zh: "干煸豆角",
    skipEnWiki: true,
    baike: ["干煸豆角", "干煸四季豆", "豆角"],
  ...
  { zh: "可乐鸡翅", commons: ["Coca-Cola chicken", "可乐鸡翅"], en: ["Chicken wing"] },
  { zh: "土豆炖牛肉", en: ["Beef stew", "Beef bourguignon"] },
  { zh: "酸菜鱼", en: ["Fish with pickled mustard greens"] },
  { zh: "清蒸鱼", commons: ["Chinese steamed fish", "清蒸鱼", "steamed fish chinese"], en: ["Fish as food"] },
  ...
  { zh: "红烧肉", en: ["Red braised pork belly"] },
  ...
  { zh: "辣子鸡", en: ["Laziji"] },
  { zh: "黄焖鸡", file: "File:Braised chicken.jpg", commons: ["黄焖鸡米饭", "Huangmenji"], en: ["Braised chicken"] },
  {
    zh: "手撕包菜",
    skipEnWiki: true,
    baike: ["手撕包菜", "包菜", "手撕卷心菜"],
  ...
  { zh: "青椒肉丝", commons: ["shredded pork pepper chinese", "青椒肉丝"], en: ["Stir-fried pork"] },
  { zh: "蛋炒饭", en: ["Fried rice"] },
  { zh: "饺子", en: ["Jiaozi"] },
  { zh: "馄饨", en: ["Wonton"] },
  { zh: "蛋花汤", en: ["Egg drop soup"] },
  { zh: "酸辣汤", en: ["Hot and sour soup"] },
  { zh: "紫菜蛋花汤", en: ["Egg drop soup", "Seaweed"], commons: ["seaweed egg soup", "紫菜蛋花汤"] },
  { zh: "糖醋排骨", commons: ["sweet and sour ribs", "糖醋排骨"], en: ["Spare ribs"] },
  {
    zh: "农家小炒肉",
    file:
  ...
  { zh: "白灼虾", file: "File:Canto white boiled shrimp.jpg", en: ["Blanched shrimp", "Shrimp"] },
  {
    zh: "葱爆羊肉",
    skipEnWiki: true,
    baike: ["葱爆羊肉", "葱爆羊肉片"],
  ...
  { zh: "韭菜炒蛋", file: "File:韭菜鸡蛋饼.jpg", commons: ["garlic chives egg", "韭菜炒蛋"], en: ["Garlic chives"] },
  { zh: "丝瓜炒蛋", file: "File:Phat buap.jpg", commons: ["luffa egg", "丝瓜"], en: ["Luffa"] },
  {
    zh: "虎皮青椒",
    skipEnWiki: true,
    baike: ["虎皮青椒", "糖醋青椒"],
  ...
  { zh: "冬瓜排骨汤", commons: ["winter melon rib soup", "冬瓜排骨"], en: ["Winter melon"] },
  { zh: "番茄鸡蛋汤", commons: ["tomato egg soup chinese", "番茄蛋花汤"], en: ["Tomato egg drop soup"] },
  { zh: "莲藕排骨汤", commons: ["lotus root pork soup", "lotus root soup pork", "莲藕汤"], en: ["Lotus root"] },
  { zh: "粉蒸肉", file: "File:粉蒸肉.jpg", commons: ["steamed pork rice flour"], en: ["Steamed pork"] },
  {
    zh: "梅菜扣肉",
  ...
  { zh: "凉拌木耳", file: "File:Water-soaked black fungus.jpg", commons: ["wood ear salad"], en: ["Wood ear mushroom"] },
];
...
async function resolveImageUrl(dish, index) {
  const { zh, en = [], commons = [], file, skipEnWiki } = dish;
...
async function main() {
  ...
  const content = `/** 由 scripts/fetch-china-home-cooking-wiki-urls.mjs 自动生成；imageUrl 为维基媒体或百度百科 CDN 直链（未下载到本地） */
